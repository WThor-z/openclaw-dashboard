...
- `tests/contracts` and `tests/gateway-sim` - contract and simulator coverage
- `infra` - environment, security, and ops verification scripts
- `reliability` - Python reliability helpers kept in the same workspace
...
tests/
  ...
  e2e/
  gateway-sim/
reliability/ Python helper package
infra/       Verification and local ops scripts
