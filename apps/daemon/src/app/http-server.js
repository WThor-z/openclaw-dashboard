...
import { createControlApiRouter } from "../domains/operations/api/control/index.js";
import { createReadApiRouter } from "../domains/operations/api/read/index.js";
import {
  assertAuthorizedControlRequest,
  assertAuthorizedReadRequest
} from "../shared/middleware/auth-gate.js";
import { HttpError, sendError, sendJson } from "../shared/middleware/error-handler.js";
import { createMonitorProvidersFromEnv } from "../platform/monitoring/collectors.js";
import { attachRequestId } from "../shared/middleware/request-id.js";
