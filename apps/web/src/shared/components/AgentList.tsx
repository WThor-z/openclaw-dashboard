    ...
    return (
      <div className="content-grid-3">
        {[
          ...
          <Skeleton key={skeletonId} variant="card" className="h-40" />
        ))}
      </div>
    );
  }
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <EmptyState
          ...
          action={
            !error ? (
              <button type="button" className="rounded-lg bg-[#1f5ba6] px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-[#174d92]">
                Initialize Agent
              </button>
            ) : null
          }
